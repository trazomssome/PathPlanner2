...
public class MainViewModel : ObservableObject
{
    ...
    private IntegratedRecipe _integratedRecipe = new();
    ...
    public ObservableCollection<PathCoordinateViewModel> Coordinates { get; } = new();
    public ObservableCollection<LineSegmentViewModel> LineSegments { get; } = new();
