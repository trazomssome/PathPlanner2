...
namespace IF_UI.RJForms
{
    public class IF_BaseForm : Form
    {
        ...
        public IF_BaseForm()
        {
            ...
            btnClose.Image = DispensePath.Properties.Resources.CloseWhite;
            ...
            btnMaximize.Image = DispensePath.Properties.Resources.MaximizeWhite;
            ...
            btnMinimize.Image = DispensePath.Properties.Resources.MinimizeWhite;
            ...
            if (isPrimaryForm)//If it is a primary form (e.g LoginForm and MainForm)
            {
                if (UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light) //If the style is supernova and the theme is light: Sets the icon to a dark color
                {
                    if (this.WindowState == FormWindowState.Normal)
                        btnMaximize.Image = DispensePath.Properties.Resources.MaximizeDark;
                    else
                        btnMaximize.Image = DispensePath.Properties.Resources.RestoreDark;
                }
                else //If it is any other theme or style: Sets the icon to a light color
                {
                    if (this.WindowState == FormWindowState.Normal)
                        ...
                        btnMaximize.Image = DispensePath.Properties.Resources.RestoreWhite;
                }
            }
        ...
        private void ApplyAppearanceSettings()
        {
            if (UIAppearance.Style == UIStyle.Supernova)//if the style is supernova
            {
                ...
                if (isPrimaryForm)
                {
                    ...
                    {
                        this.btnClose.Image = DispensePath.Properties.Resources.CloseDark;
                        this.btnMaximize.Image = DispensePath.Properties.Resources.MaximizeDark;
                        this.btnMinimize.Image = DispensePath.Properties.Resources.MinimizeDark;
                    }
                }
            }
        }
        ...
        {
            if (isPrimaryForm && UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light)
                btnMinimize.Image = DispensePath.Properties.Resources.MinimizeDark;
        }
        ...
        {
            if (isPrimaryForm && UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light)
                btnClose.Image = DispensePath.Properties.Resources.CloseDark;
        }
